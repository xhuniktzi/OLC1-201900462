...
const fnSemanticMinus = (
  ...
  if (type === null) {
    throw new Error(
      "Semantic Error: Cannot subtract two booleans or two chars."
    );
  }

  if (type === Datatype.STRING) {
    throw new Error("Semantic Error: Cannot subtract two strings.");
  } else {
    return {
...
export default fnSemanticMinus;
